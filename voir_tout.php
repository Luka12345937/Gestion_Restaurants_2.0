...
<head>
    ...
    <title>Voir Tout - Gestion de Commandes</title>
...
<body>
    ...
    <div class="container">
        <div class="content">
            <h1>Voir Tout</h1>
            <p>Explorez toutes les fonctionnalités et les avantages de notre application de gestion de commandes. Découvrez comment nous pouvons vous aider à optimiser vos processus.</p>
    ...
    <footer>
        <p>&copy; 2023 Gestion de Commandes. Tous droits réservés. | <a href="voir_tout.php">Voir Tout</a></p>
    </footer>
</body>
</html>
